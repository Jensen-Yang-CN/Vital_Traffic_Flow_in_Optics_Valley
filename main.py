...
DATA_PATHS = {
    ...
    "guanggu": {"feat": "data/guanggu_speed.csv", "adj": "data/guanggu_adj.csv"},
...
def main_supervised(args):
    ...
    trainer = pl.Trainer.from_argparse_args(
        args,
        callbacks=callbacks,
        logger=[csv_logger]  # 添加 CSV logger
    )
    trainer.fit(task, dm)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data", type=str, help="The name of the dataset", choices=("shenzhen", "losloop", "guanggu"),
        default="guanggu"
    )
    parser.add_argument(
        "--model_name",
